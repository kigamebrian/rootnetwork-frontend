                ...
                <Link to={`/blog/post/${post.slug}`} className="text-decoration-none">
                  <div className="hero-card position-relative" style={{ height: '450px', overflow: 'hidden' }}>
                    ...
                    <div className="hero-overlay position-absolute bottom-0 start-0 end-0 p-4 text-white"
                      ...
                      <span className="badge badge-theme mb-2">{post.category?.name || 'News'}</span>
          ...
          <div className="col-lg-8">
            ...
            <section className="mb-5">
              <div className="d-flex justify-content-between align-items-center mb-4">
                <h2 className="h4 mb-0 fw-bold text-theme">Latest Stories</h2>
                <Link to="/blog" className="link-theme">View All →</Link>
              </div>
              <div className="row">
            ...
            {entertainmentPosts.length > 0 && (
              <section className="mb-5">
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <h3 className="h5 fw-bold mb-0 text-theme">🎬 Entertainment</h3>
                  <Link to="/category/entertainment" className="link-theme small">More →</Link>
                </div>
                <div className="row">
            ...
            {businessPosts.length > 0 && (
              <section className="mb-5">
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <h3 className="h5 fw-bold mb-0 text-theme">💼 Business</h3>
                  <Link to="/category/business" className="link-theme small">More →</Link>
                </div>
                <div className="row">
            ...
            {lifeStylePosts.length > 0 && (
              <section className="mb-5">
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <h3 className="h5 fw-bold mb-0 text-theme">✨ Lifestyle</h3>
                  <Link to="/category/lifestyle" className="link-theme small">More →</Link>
                </div>
                <div className="row">
            ...
            <div className="text-center my-5">
              <Link to="/blog" className="btn btn-theme px-5 py-2 rounded-pill">
              ...
              <div className="card mb-4 border-0 shadow-sm">
                ...
                <div className="card-body p-0">
                  {popularPosts.map((post, index) => (
                    ...
                    >
                      <div className="popular-circle rounded-circle d-flex align-items-center justify-content-center me-3 fw-bold"
                  ...
                  <div className="row">
                    {categories.map(cat => (
                      <div className="col-6 mb-2" key={cat.id}>
                        ...
                        >
                          <i className="fas fa-tag me-1 text-theme"></i> {cat.name}
                        </Link>
                      </div>
                    ))}
                  </div>
